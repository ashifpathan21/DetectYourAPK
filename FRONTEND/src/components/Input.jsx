...
const Input = () => {
  ...
  return (
    <div
      className={`border-2 w-11/12 mx-auto mt-10 min-h-50 flex flex-col justify-center items-center border-dashed rounded-lg p-6 text-center transition ${
        dragActive ? "border-cyan-800 bg-cyan-100" : "border-cyan-900"
      }`}
      onDragOver={(e) => {
        e.preventDefault();
        e.stopPropagation();
